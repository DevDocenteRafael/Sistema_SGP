...
export default {
  ...
  data() {
    return {
      menuAberto: false,
      menuRecolhido: localStorage.getItem('siped_menu_recolhido') === 'true'
        || localStorage.getItem('sgp_menu_recolhido') === 'true',
    };
  },
  computed: {
    cicloBarraAzul() {
  ...
  methods: {
    ...
    alternarRecolhimento() {
      ...
      localStorage.setItem('siped_menu_recolhido', String(this.menuRecolhido));
      localStorage.removeItem('sgp_menu_recolhido');
    },
    onResize() {
