      ...
      <div v-else class="flux-lista-grid">
        ...
        >
          ...
          <div v-if="podeEditar" class="flux-card-actions" @click.stop>
            <button type="button" class="flux-icon-btn" title="Editar dados" aria-label="Editar dados" @click="abrirEdicao(item)">
              <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M17 3a2.85 2.83 0 1 1 4 4L7.5 20.5 2 22l1.5-5.5Z"/></svg>
            </button>
            <button type="button" class="flux-icon-btn danger" title="Excluir" aria-label="Excluir" @click="excluir(item)">
