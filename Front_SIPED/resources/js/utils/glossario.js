/**
 * Glossário central do SIPED — textos curtos para tooltips/ajuda contextual.
...
export const STATUS = {
  ...
  'em tramitacao (fora da cped)': 'TR encaminhado a outra área; ainda acompanhado no SIPED.',
  'em tramitação (fora da cped)': 'TR encaminhado a outra área; ainda acompanhado no SIPED.',
...
export const TERMOS = {
  ...
  cped: 'Coordenação Pedagógica — área gestora do portfólio no SIPED.',
  ...
  'ciclo de gestão': 'Período de trabalho selecionado no SIPED. Afeta cadastros periódicos, indicadores, relatórios e importações.',
  'ciclo de portfólio': 'Nome antigo do ciclo de gestão; o conceito agora é global em todo o SIPED.',
