            ...
            <tbody>
              <tr v-for="termo in termos" :key="termo.id">
                ...
                <td class="text-center acoes">
                  <button type="button" class="btn-icon btn-view" title="Visualizar" aria-label="Visualizar" @click="abrirDetalhes(termo)">
                    <svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"><path d="M2 12s3-7 10-7 10 7 10 7-3 7-10 7-10-7-10-7Z"/><circle cx="12" cy="12" r="3"/></svg>
                  </button>
                  <button v-if="podeEditar" type="button" class="btn-icon btn-edit" title="Editar" aria-label="Editar" @click="abrirEdicao(termo)">
                  ...
                  <button v-if="podeEditar" type="button" class="btn-icon btn-delete" title="Excluir" aria-label="Excluir" @click="iniciarExclusao(termo)">
      ...
      >
        <div class="modal-detalhes" role="dialog" aria-labelledby="detalhes-tr-titulo">
          <div class="modal-detalhes-header">
            ...
            <button type="button" class="btn-fechar-x" title="Fechar" aria-label="Fechar" @click="detalheAberto = false">
              ×
            </button>
          </div>
