                ...
                <div v-if="grupo.tipo === 'ordenador'" class="funcao-ordenador">
                  ...
                  >
                    <div v-if="podeEditar" class="card-actions" @click.stop>
                      <button type="button" class="icon-btn edit" title="Editar" @click="abrirEdicao(pessoa)">
                      ...
                      <button type="button" class="icon-btn delete" title="Excluir" @click="excluir(pessoa)">
