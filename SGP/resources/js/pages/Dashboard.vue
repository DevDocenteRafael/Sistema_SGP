  ...
  <div class="dashboard-page">
    ...
    <template v-if="filtros.grupo === 'gerais'">
      <section class="dashboard-metrics-grid">
        <article
          class="dashboard-metric-card dashboard-quick-card is-accent"
          role="button"
          tabindex="0"
          @click="$router.push({ name: 'controle-de-resolucoes' })"
          @keydown.enter.prevent="$router.push({ name: 'controle-de-resolucoes' })"
          @keydown.space.prevent="$router.push({ name: 'controle-de-resolucoes' })"
        >
          <div class="dashboard-metric-top">
            ...
            <span class="dashboard-metric-sub">Acesso rápido</span>
          </div>
          <p class="dashboard-metric-value">Resoluções</p>
          <p class="dashboard-metric-title">Controle de Resoluções</p>
        </article>
